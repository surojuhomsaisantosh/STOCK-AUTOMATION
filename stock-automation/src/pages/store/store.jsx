          ...
          <div style={styles.menuContainer}>
            <div style={styles.stickyActionHeader}>
              <div style={styles.actionRow}>
                ...
                <button style={{...styles.greenCardBtn, background: isConnected ? PRIMARY : '#6b7280'}} onClick={connectPrinter} disabled={isConnecting}>
      ...
      {showPaymentModal && (
        <div style={styles.modalOverlay}>
          <div style={styles.modalHorizontal}>
            ...
            <div style={styles.modalFlexBody}>
...
const styles = {
  ...
  modalOverlay: { position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.6)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, backdropFilter: 'blur(10px)' },
  modalHorizontal: { background: "#fff", borderRadius: "32px", padding: "35px", width: "920px", height: 'auto', display: 'flex', flexDirection: 'column', boxShadow: "0 40px 80px rgba(0,0,0,0.3)" },
