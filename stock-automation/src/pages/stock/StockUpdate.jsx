...
import { 
  ...
  Search, Package, AlertTriangle, Calendar, CheckCircle
} from "lucide-react";
        ...
        <div className="flex flex-col lg:flex-row gap-4 justify-between mb-6">
          <div className="flex flex-col sm:flex-row gap-3 flex-1 max-w-5xl">
            ...
            <button 
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-2xl font-black border-2 transition-all ${
                showLowStockOnly ? "bg-rose-50 border-rose-600" : "bg-white border-slate-200"
              }`}
            >
              ...
              <span className={`text-xs font-black px-3 py-1 rounded-lg border ${
                showLowStockOnly ? "bg-rose-600 text-white border-rose-600" : "bg-slate-100 text-black border-slate-200"
              }`}>
                {lowStockCount}
              </span>
            </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-white w-full max-w-4xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border-4 border-black">
            ...
            <div className="p-8 overflow-y-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-black">
              ...
              <div className="md:col-span-3 border-b-2 border-black pb-2 mt-4 font-black uppercase tracking-widest text-xs">Stock & Compliance</div>
